...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto relative", className)}>
      <ComboboxPrimitive.Input
        render={(renderProps: any) => {
          const value = renderProps?.value
          const valueExists = Boolean(value && value !== "")
          ...
          return (
            <InputGroupInput 
              ...
              className={cn(valueExists && children && "text-transparent", renderProps.className)} 
            />
          )
        }}
        {...props}
